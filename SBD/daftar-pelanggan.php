...
<body>
    ...
    <div class="container">
        <h2 class="text-center">Daftar sebagai Pelanggan</h2><br>
        <div class="card">
            <div class="card-body">
                ...
                <?php if (isset($_POST['Daftar'])) {
                    ...
                    $perintah=$koneksi->query("SELECT * FROM pelanggan WHERE email='$_POST[email]'");
                    ...
                    if($sama==1){
                        ...
                        if($_POST['password']!=$_POST['password1']){
                            ...
                            $koneksi->query("INSERT INTO pelanggan(NIK,nama_pelanggan,email,password,no_hp,alamat,foto_profil) VALUES ('$_POST[nik]','$_POST[nama]','$_POST[email]','$_POST[password]','$_POST[hp]','$_POST[alamat]','$nama')");
